...
In addition, recent retrieval research in advertising contexts indicates that real-time, intent-aware retrieval design is increasingly important when language models are deployed in production decision pipelines \cite{b22}.
...
Recent survey work also reports rapid growth of agentic approaches for complex text analytics tasks \cite{b10}.
...
Bias-related concerns in model behavior have likewise been documented in broader comparative analyses of large language models \cite{b24}.
...
For production environments, lessons from real-time ad retrieval research also suggest that latency-aware retrieval design is critical for scaling deployment \cite{b22}.
...
More broadly, large-scale evidence on online information diffusion continues to show that false information can spread faster and wider than verified content, reinforcing the need for robust detection-and-explanation pipelines \cite{b65}.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{brian.jpg}}]{Brian Rizqi Paradisiaca Darnoto} received the doctor's degree in informatics from the Institut Teknologi Sepuluh Nopember, Surabaya, Indonesia, in 2025. He is a Lecturer at the University of Jember, Indonesia. His research interests include artificial intelligence, natural language processing, and software engineering.
\end{IEEEbiography}
